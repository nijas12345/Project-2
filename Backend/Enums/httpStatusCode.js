...
(function (HTTP_statusCode) {
    ...
    HTTP_statusCode[HTTP_statusCode["Created"] = 201] = "Created";
    HTTP_statusCode[HTTP_statusCode["Accepted"] = 202] = "Accepted";
    ...
    HTTP_statusCode[HTTP_statusCode["UnprocessableEntity"] = 422] = "UnprocessableEntity";
    HTTP_statusCode[HTTP_statusCode["InternalServerError"] = 500] = "InternalServerError";
    HTTP_statusCode[HTTP_statusCode["BadGateway"] = 502] = "BadGateway";
    HTTP_statusCode[HTTP_statusCode["ServiceUnavailable"] = 503] = "ServiceUnavailable";
    HTTP_statusCode[HTTP_statusCode["GatewayTimeout"] = 504] = "GatewayTimeout";
    HTTP_statusCode[HTTP_statusCode["TooManyRequests"] = 429] = "TooManyRequests";
