...
exports.sendOTPmail = exports.sendInvoiceEmail = exports.sendResetPasswordLink = exports.sendInvitationLink = void 0;
const nodemailer = require("nodemailer");
const dotenv_1 = __importDefault(require("dotenv"));
const jwt_config_1 = require("./jwt_config");
dotenv_1.default.config();
const sendInvitationLink = async (email, refferalCode) => {
...
const sendResetPasswordLink = async (email, role) => {
    const token = (0, jwt_config_1.resetPasswordToken)(email, role);
...
const sendInvoiceEmail = async (customerEmail, amountPaid, currencyDollar, invoiceUrl) => {
    const transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
            user: process.env.ServerEmail,
